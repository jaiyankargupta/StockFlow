      ...
      <div className="flex flex-col gap-1.5">
        ...
        <div className="relative">
          ...
          <input
            ref={ref} id={inputId}
            className={cn(
              'w-full h-9 rounded-md border bg-white px-3 py-2 text-sm text-neutral-900 placeholder:text-neutral-400',
              'border-neutral-300 focus:border-indigo-500 focus:ring-1 focus:ring-indigo-500 focus:outline-none',
              'dark:bg-neutral-900 dark:border-neutral-700 dark:text-neutral-100 dark:placeholder:text-neutral-500 dark:focus:border-indigo-400 dark:focus:ring-indigo-400',
